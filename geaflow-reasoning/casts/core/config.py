...
class DefaultConfiguration(Configuration):
    ...
    SIMULATION_ENABLE_VISUALIZER = True  # If True, generates visualizations of simulation results.
    SIMULATION_VERBOSE_LOGGING = False  # If True, prints detailed step-by-step simulation logs.
    ...
    # Multiplier for Tier-2 (similarity) confidence threshold. `tier2_threshold = TIER1_THRESHOLD * TIER2_GAMMA`.
    CACHE_TIER2_GAMMA = 1.2
    # Controls the sensitivity of the similarity threshold. Higher kappa = stricter similarity matching.
    CACHE_SIMILARITY_KAPPA = 0.25
    # Controls how much a SKU's confidence score affects its similarity threshold. Higher beta = more confident SKUs are easier to match.
