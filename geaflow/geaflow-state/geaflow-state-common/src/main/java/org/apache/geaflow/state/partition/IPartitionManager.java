 ...
 * This interface provides methods for parsing filters, managing partition metadata,
 * and retrieving partition information.
 */
public interface IPartitionManager {

    /**
     * Parse labels from a filter to determine which partitions to scan.
     *
     * @param filter the filter to parse
     * @return list of labels found in the filter
     */
     ...
     *
     * @param partitionName the name of the partition
     * @return partition metadata, or null if partition doesn't exist
     */
    PartitionMetadata getPartitionMetadata(String partitionName);

    /**
     * Register a new partition with its metadata.
     *
     * @param partitionName the name of the partition
     * @param metadata the metadata for the partition
     */
     ...
     *
     * @param partitionName the name of the partition to unregister
     */
