...
public class AsyncGraphLmdbProxy<K, VV, EV> extends SyncGraphLmdbProxy<K, VV, EV> {

    private final AsyncFlushBuffer<K, VV, EV> flushBuffer;

    public AsyncGraphLmdbProxy(LmdbClient lmdbClient,
                                  IGraphKVEncoder<K, VV, EV> encoder,
                                  Configuration config) {
        super(lmdbClient, encoder, config);
