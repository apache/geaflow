...
import static org.apache.geaflow.store.lmdb.LmdbConfigKeys.DEFAULT_CF;
...
import org.apache.geaflow.store.lmdb.proxy.IGraphLmdbProxy;
import org.apache.geaflow.store.lmdb.proxy.ProxyBuilder;

public class StaticGraphLmdbStore<K, VV, EV> extends BaseLmdbGraphStore implements
    IStaticGraphStore<K, VV, EV> {

    private IGraphLmdbProxy<K, VV, EV> proxy;
    ...
    public void init(StoreContext storeContext) {
        ...
        partitionType = PartitionType.getEnum(storeContext.getConfig()
            .getString(LmdbConfigKeys.ROCKSDB_GRAPH_STORE_PARTITION_TYPE));
        ...
        this.proxy = ProxyBuilder.build(config, lmdbClient, encoder);
    }
