...
import org.apache.geaflow.store.lmdb.proxy.IGraphMultiVersionedLmdbProxy;
import org.apache.geaflow.store.lmdb.proxy.ProxyBuilder;

public class DynamicGraphLmdbStore<K, VV, EV> extends BaseLmdbGraphStore
    implements IDynamicGraphStore<K, VV, EV> {

    private IGraphMultiVersionedLmdbProxy<K, VV, EV> proxy;
    ...
    public void init(StoreContext storeContext) {
        ...
        this.proxy = ProxyBuilder.buildMultiVersioned(config, lmdbClient, encoder);
    }
