...
public class DorisTableConnector implements TableReadableConnector, TableWritableConnector {

    public static final String TYPE = "DORIS";
    ...
    public TableSource createSource(Configuration conf) {
        return new DorisTableSource();
    }

    @Override
    public TableSink createSink(Configuration conf) {
        return new DorisTableSink();
    }
}
