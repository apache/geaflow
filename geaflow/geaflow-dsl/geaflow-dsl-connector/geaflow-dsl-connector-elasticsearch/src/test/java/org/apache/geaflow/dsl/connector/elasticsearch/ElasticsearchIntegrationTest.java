...
public class ElasticsearchIntegrationTest {
    ...
    @BeforeClass
    public void setUp() {
        // Skip integration tests in CI environment if Docker is not available
        String skipIntegrationTests = System.getProperty("skipIntegrationTests", "false");
        if ("true".equalsIgnoreCase(skipIntegrationTests)) {
            throw new org.testng.SkipException("Integration tests are disabled");
        }
        ...
        try {
            ...
            if (exitCode != 0) {
                throw new org.testng.SkipException("Docker is not running");
            }
        } catch (IOException | InterruptedException e) {
            throw new org.testng.SkipException("Docker is not available, skipping test");
        }
