...
import org.apache.geaflow.dsl.connector.api.TableDeserializer;
import org.apache.geaflow.dsl.connector.api.TableSource;
import org.apache.geaflow.dsl.connector.api.serde.TableDeserializerImpl;
import org.apache.geaflow.dsl.common.data.Row;
import org.apache.geaflow.dsl.common.types.TableSchema;
import org.apache.geaflow.dsl.common.types.StructType;
import org.apache.geaflow.dsl.connector.api.serde.FetchWindow;
...
public class ElasticsearchTableSource implements TableSource {
    ...
    public void init(Configuration tableConf, TableSchema tableSchema) {
        this.schema = tableSchema.getSchema();
    ...
    public <IN> TableDeserializer<IN> getDeserializer(Configuration conf) {
        return new TableDeserializerImpl<IN>() {
            @Override
            public Row deserialize(IN record) {
                if (record instanceof SearchHit) {
                    ...
                    return new org.apache.geaflow.dsl.common.data.impl.ObjectRow(values);
                }
                return null;
            }
        };
    ...
    public <T> FetchData<T> fetch(Partition partition, Optional<org.apache.geaflow.dsl.connector.api.Offset> startOffset, FetchWindow windowInfo) throws IOException {
        try {
            ...
            return new FetchData<>(dataList, null);
        } catch (Exception e) {
