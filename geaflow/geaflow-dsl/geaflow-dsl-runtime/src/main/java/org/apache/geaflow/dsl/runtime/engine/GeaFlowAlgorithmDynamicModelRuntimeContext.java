...
public class GeaFlowAlgorithmDynamicModelRuntimeContext extends GeaFlowAlgorithmDynamicRuntimeContext
    implements AlgorithmModelRuntimeContext<Object, Object> {

    public GeaFlowAlgorithmDynamicModelRuntimeContext(
    ...
    public Row loadDynamicVertexValue(Object vertexId) {
        if (!Objects.equals(getVertexId(), vertexId)) {
            return null;
        }
        IVertex<Object, Row> vertex = getIncVCTraversalCtx().getTemporaryGraph().getVertex();
        return vertex == null ? null : vertex.getValue();
    }
    ...
    public List<RowEdge> loadDynamicEdges(Object vertexId, EdgeDirection direction) {
        ...
        return super.loadDynamicEdges(direction);
    }
